...
y_true1,y_pred = analysis.confusion_matrix()
y_true=y_true1[:len(y_pred)]
print("Total Number of testing sample:",len(y_true1))
print("Total Number of correct prediction: ",len(y_pred))
print("Testing accuracy: "+str((len(y_pred)/len(y_true1))*100)+"%")
confusion_martix = confusion_matrix(y_true, y_pred)
print(confusion_martix)
# a tuple for all the class names
target_names = ("Open_Eyes","Closed_Eyes")
